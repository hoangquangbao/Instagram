...
struct MockData {
    ...
    static let conversations: [Conversation] = [
        Conversation(id: "1", user1: users[0], user2: users[1], messages: [
            Message(id: "1", sender: users[0], text: "Hello \(users[1].fullName)"),
            Message(id: "2", sender: users[1], text: "Hello Duc"),
        ]),
        Conversation(id: "2", user1: users[2], user2: users[0], messages: [
            Message(id: "1", sender: users[0], text: "Hello \(users[2].fullName)"),
            Message(id: "2", sender: users[2], text: "Hello Duc"),
            Message(id: "1", sender: users[0], text: "Nice to meet you"),
        ])
    ]
    
    static let messages: [Message] = [
        Message(id: "1", sender: users[0], text: "Hello Duc"),
        Message(id: "2", sender: users[1], text: "Abcdem"),
    ]
}
